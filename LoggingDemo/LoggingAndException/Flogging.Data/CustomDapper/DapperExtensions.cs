...
namespace LoggingDemo.LoggingAndException.Flogging.Data.CustomDapper
{
    public static class DapperExtensions
    {
        ...
        private static void AddDetailsToException(Exception ex, string procName, object paramList)
        {
            ...
            if (paramList is DynamicParameters)
            {
                DynamicParameters dynParams = (DynamicParameters)paramList;
